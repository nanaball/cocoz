// 15_quiz_array_function.js
// alert('js 파일 html 문서에 적용!');

/*
    점수를 등록할 배열, 입력 받을 점수 크기, 교과목 이름 
    3개의 매개변수를 전달 받아 입력받을 점수 크기만큼 배열에 사용자로부터 점수를 입력받아 등록하고 점수가 등록된 배열을 반환
*/
...
/*
    점수가 저장된 배열을 매개변수로 전달받아 최대값을 검색하여 반환
*/
...
/*
    점수가 저장된 배열을 매개변수로 전달받아 최소값을 검색하여 반환
*/
...
/*
    점수가 저장된 배열을 매개변수로 전달받아 전체 합계를 반환
*/
...
/*
    점수가 저장된 배열을 매개변수로 전달받아 전체 평균을 반환
*/
